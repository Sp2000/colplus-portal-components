...
class DatasetlogoWithStatusText extends React.Component {
  constructor(props) {
    super(props);
  ...
  render() {
    ...
    return (loading || !error) ?  
        <img
          style={style}
          src={`${config.dataApi}dataset/${catalogueKey}/source/${datasetKey}/logo?size=${size}`}
...
export default DatasetlogoWithStatusText;