...
{ data && (
          ...
          <PresentationItem label="Organisations">
            {data.organisations}
          </PresentationItem>
          ...
          {data.gbifKey && <PresentationItem label="GBIF">
             <a href={`https://www.gbif.org/dataset/${data.gbifKey}`} target="_blank" >Browse in GBIF</a>
          </PresentationItem>}
